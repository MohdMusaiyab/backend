...
- Understand every piece before moving on.
- Trying to learn better tech decisions and system architecture decisions kind of thing.
- Use AI only as a sounding board, not a replacement for thinking.


## 🧩 What's next?

More small projects as I keep learning. Suggestions and feedback are welcome.

---

*Built with intent to be able to write code without AI — at least the syntax and system design fundamentals.*
